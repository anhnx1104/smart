...
const MembershipClassTable = () => {
  ...
  const renderAction = (row: MembershipClass) => {
    return (
      <>
        ...
        <LinkIconButton to={`/membershipClass/list/${row.id}`}>
          <IconButton>
            <VisibilityIcon />
          </IconButton>
        </LinkIconButton>
        <LinkIconButton to={`/membershipClass/list/${row.id}/edit`}>
          <IconButton>
            <EditIcon />
          </IconButton>
        </LinkIconButton>
  ...
  return (
    <TableWrapper sx={{ height: 1 }} component={Paper}>
      <TableMembershipClassSearchField
      ...
      >
        <LinkButton
          variant="outlined"
          startIcon={<AddIcon />}
          to="/membershipClass/list/create"
        >
          Thêm mới
        </LinkButton>
      </TableMembershipClassSearchField>
