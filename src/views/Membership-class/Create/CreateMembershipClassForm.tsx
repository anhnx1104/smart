...
const CreateMembershipClassForm = () => {
  ...
  return (
    <FormPaperGrid noValidate onSubmit={handleSubmit(onSubmit)}>
      <FormHeader title="Tạo mới hạng hội viên" />
      <FormContent>
        <Box>
        ...
        <FormGroup>
          <Grid container alignItems="center" spacing={3} style={{padding: 20}}>
            ...
            <Grid item xs={12} sm={8} md={4}>
              <ControllerTextField name="name" control={control} placeholder={"Tên hạng"}/>
            </Grid>
            <Grid item xs={12} sm={4} md={2}>
              <FormLabel required title="Mô tả" name="description" />
            </Grid>
            <Grid item xs={12} sm={8} md={4}>
              <ControllerTextField name="description" control={control} placeholder={"Mô tả"}/>
            </Grid>
          </Grid>
        </FormGroup>
        <Divider />
        <FormGroup>
          <Grid container alignItems="center" spacing={3} style={{padding: 20}}>
            ...
            <Grid item xs={12} sm={8} md={4}>
              <ControllerTextField name="categories" control={control} placeholder={"Hạng thấp nhất là 1"}/>
            </Grid>
        ...
        <FormGroup>
          <Grid container alignItems="center" spacing={3} style={{padding: 20}}>
            ...
            <Grid item xs={12} sm={8} md={4}>
              <ControllerTextField name="condition" control={control} value={"Điểm xếp hạng"} disabled/>
            </Grid>
            <Grid item xs={12} sm={4} md={2}>
              <FormLabel required title="Điểm xét hạng" name="pointOfClass" />
            </Grid>
            <Grid item xs={12} sm={8} md={4}>
              <ControllerTextField name="pointOfClass" control={control} placeholder={"Điểm xét hạng"}/>
            </Grid>
          </Grid>
        </FormGroup>
        <Divider />
        <FormGroup>
          <Grid container alignItems="center" spacing={3} style={{padding: 20}}>
            ...
            <Grid item xs={12} sm={8} md={4}>
              <Box sx={{ display: 'flex' }}>
                <TextField style={{width:"60%"}} value={image?.name} disabled placeholder={"Ảnh hạng thẻ"}/>
                <ImageButton
                  accept="image/*"
                  maxFiles={1}
